...
public class ReservationController {
    ...
    public Reservation findReservationById(@PathVariable("reservationId") Long reservationId) {
        return reservationService.findReservationById(reservationId);
    }

    @GetMapping(path = "transaction/{transactionId}")
    public Reservation findReservationByTransactionId(@PathVariable("transactionId") String reservationId) {
    ...
    public List<Reservation> findAllReservationsForUser(@PathVariable("userId") Long userId) {
    ...
    @PutMapping(path = "{id}")
    public void updateReservation(@PathVariable("id") Long id, @RequestBody ReservationUpdateRequest updateRequest) {
